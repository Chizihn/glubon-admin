...
export const Modal: React.FC<ModalProps> = ({
  ...
  const baseOverlayClasses = 'fixed inset-0 bg-black bg-opacity-50 z-50 transition-opacity duration-200';
  ...
  const baseModalClasses = 'fixed bg-white shadow-lg z-50 flex flex-col overflow-hidden max-h-[95vh]';
        ...
        <div className={headerClasses}>
          ...
          {showCloseButton && (
            <button 
              ...
              className="p-1 text-gray-500 hover:text-gray-800 text-2xl leading-none"
            >
              &times;
            </button>
          )}
